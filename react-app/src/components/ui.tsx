...
export function Button(props: ButtonAsButton | ButtonAsLink) {
  ...
  if ('to' in props && props.to) {
    ...
    const { children: _children, className: _className, disabled, icon: _icon, to, trailingIcon: _trailingIcon, variant: _variant, ...linkProps } = linkButton
    return (
      <Link
        {...linkProps}
  ...
  const { children: _children, className: _className, icon: _icon, trailingIcon: _trailingIcon, variant: _variant, ...buttonProps } = button
  return (
...
export function BrandLogo({ label = 'OakBoard' }: { label?: string }) {
  return (
    <div className="ob-brand">
      <span className="ob-brand__mark"><img src="/oakboard-logo.svg" alt="" /></span>
      <span>{label}</span>
    </div>
  )
}
